                                    ...
                                    : (
                                        <nav class='homeNav'>
                                            <ul>
                                                ...
                                                <li><a id='recette' onClick={this.handleOnClick}>Recettes</a></li>
                                                <li><a id='ingredient' onClick={this.handleOnClick}>Ingrédients</a></li>
                                                <li><a id='category' onClick={this.handleOnClick}>Categories</a></li>
                                                ...
                                                <li><a id='logout' onClick={this.handleOnClick}>Déconnexion</a></li>
                                            </ul>
                                        </nav>
                                    )}
